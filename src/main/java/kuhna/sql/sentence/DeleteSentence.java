...
/**
 * Delete문장, 다양한 메쏘드를 통해 Delete문장을 구성할 수 있다. 
 *
 * @version 0.4.2, 2011/12/14, fixed toString() bug by A.J.Kuhn<BR><!-- 
 * @version -->0.4.1, 2006/05/10, added setWhereTermsAnd() method by A.J.Kuhn<BR><!-- 
 * @version -->0.4, 2004/05/13, added term relative methods by A.J.Kuhn<BR><!--  
 * @version -->0.3, 2004/04/29, this class extended SQLSentence not implemented by A.J.Kuhn<BR><!--  
 * @version -->0.2.3, 2003/09/29, add setTerms(x) method by A.J.Kuhn<BR><!--  
 ...
 */
public class DeleteSentence extends SQLSentence {

  private final String _delete = "delete from ";
